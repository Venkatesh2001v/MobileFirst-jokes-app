...
const Homepage = () => {
  ...
  var rowColors = ["table-primary", "table-success", "table-danger", "table-info", "table-warning", "table-active", "table-secondary", "table-light", "table-primary", "table-dark"]
  ...
  return (
    <div className="container d-flex flex-column align-items-center justify-content-center h-100 w-100 pt-3 pb-3">
      ...
      {isLoading ? (
        <div className="spinner-border text-info align-self-center mt-5" role="status">
